...
import { faChartLine, faCloudUploadAlt, faRocket, faTasks, faUserShield } from '@fortawesome/free-solid-svg-icons';
...
const exportToExcel = (e) => {
  if (e && e.activeLabel) {
    ...
    axios({
      url: `${process.env.REACT_APP_BASE_URL}/detailedition/${moment(dates).format('YYYY-MM-DD')}/august`,
      method: 'GET',
      responseType: 'blob',
    }).then((response) => {
...
export default () => {
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_BASE_URL}/chart/colours/viewscount/august`)
      .then(function (res) {
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/chart/colours/clickscount/august`)
      .then(function (res) {
        const str = res.data[0].views || 0;
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/chart/colours/viewsdevices/august`)
      .then(function (res) {
        var counts = 0;
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/chart/colours/views/august`)
      .then(function (res) {
        var arr1 = [], arr2 = [], arr3 = [];
      ...
      <Row className="justify-content-md-center">
        ...
        <Col xs={12} sm={6} xl={6} className="mb-4">
          <Row>
            ...
            <Col xs={12} className="mb-4">
              <PageVisitsTable app="colours" edition="august" />
            </Col>
          </Row>
