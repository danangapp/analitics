...
import { CounterWidget, CircleChartWidget, BarChartWidget, TeamMembersWidget, ProgressTrackWidget, RankingWidget, SalesValueWidgetMay, SalesValueWidgetPhone, AcquisitionWidget } from "../components/Widgets";
...
const exportToExcel = (e) => {
  if (e && e.activeLabel) {
    ...
    axios({
      url: `${process.env.REACT_APP_BASE_URL}/detailedition/${moment(dates).format('YYYY-MM-DD')}/may`,
      method: 'GET',
      responseType: 'blob',
    }).then((response) => {
      ...
      <Row className="justify-content-md-center">
        ...
        <Col xs={12} sm={6} xl={6} className="mb-4">
          <Row>
            ...
            <Col xs={12} className="mb-4">
              <PageVisitsTable app="colours" edition="may" />
            </Col>
          </Row>
